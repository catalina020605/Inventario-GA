    ...
    if (categorias == "granos") {
        switch (producto) {
            case producto = "arroz":
                ...
                cantidadPro = pedirCantidad("Ingrese la cantidad del producto")
                localStorage.setItem("arroz", parseInt(cantidad) + cantidadPro)
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("arroz"));
                break;
            case producto = "frijoles":
                cantidad = localStorage.getItem("frijoles")
                cantidadPro = pedirCantidad("Ingrese la cantidad del producto")
                localStorage.setItem("frijoles", parseInt(cantidad) + cantidadPro)
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("frijoles"));
                break;
            ...
            case producto = "lentejas":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("lentejas"));
                break;
            default:
    ...
    if (categorias == "aseo") {
        switch (producto) {
            case producto = "jabon":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("jabon"));
                break;
            ...
            case producto = "limpido":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("limpido"));
                break;
            ...
            case producto = "champu":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("champu"));
                break;
    ...
    if (categorias == "carnes") {
        switch (producto) {
            case producto = "pescado":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("pescado"));
                break;
            ...
            case producto = "res":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("res"));
                break;
            ...
            case producto = "cerdo":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("cerdo"));
                break;
            break;
            default:
                break;
    ...
    if (categorias == "lacteos") {
        switch (producto) {
            case producto = "kumis":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("kumis"));
                break;
            ...
            case producto = "yogurt":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("yogurt"));
                break;
            ...
            case producto = "leche":
                ...
                console.log("La cantidad del " + producto + " ha sido actualizada a", localStorage.getItem("leche"));
                break;
...
export { ingresarUsuario, ingresarExistencias, pedirCantidad };
